...
:MAKEBATCH
  ...
  copy ProcessTlogsFinal_run_piece1.txt ProcessTlogsFinal_run.cmd
  ...
  copy ProcessTlogsFinal_run.cmd /A + ProcessTlogsFinal_run_piece2.txt /A ProcessTlogsFinal_run.cmd /A
...
:BUILDCMD
  :: Build and copy in dynamic piece of subprogram.
  @set TLOG_STORE=%1
  @echo @call :DECOMPRESS %TLOG_STORE% >> E:\Poll\Bin\ProcessTlogsFinal_run.cmd
  @echo @if ERRORLEVEL 1 goto ERR >> E:\Poll\Bin\ProcessTlogsFinal_run.cmd
  @goto :EOF
...
:DECOMPRESS
  ...
  call E:\Poll\Bin\ProcessTlogsFinal_run.cmd
...
:NOMAIL01
  ...
  @if exist E:\Poll\Tlog\Tlog*.* E:\Poll\Bin\MoveFiles.exe E:\Poll\Tlog\*.* E:\Poll\Tlog\NoMail01
  @if errorlevel 1 @call :MESS Error moving files from E:\Poll\Tlog to E:\Poll\Tlog\NoMail01 & set WARNING_FLAG=TRUE
  @if exist E:\Poll\TlogT\Zip\Tlog*.* E:\Poll\Bin\MoveFiles.exe E:\Poll\TlogT\Zip\*.* E:\Poll\TlogT\NoMail01\Zip
  @if errorlevel 1 @call :MESS Error moving files from E:\Poll\TlogT\Zip to E:\Poll\TlogT\NoMail01\Zip & set WARNING_FLAG=TRUE
...
:ERREND
  ...
  @echo.
  @blat %LOG_FILE% -subject "ERROR: ProcessTlogsFinal" -to christian.adams@spencergifts.com
