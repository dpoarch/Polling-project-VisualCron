...
::  for /F %%E in (E:\Poll\StoreMailT\Sitelist.txt) do @call :BUILDCMD %%E || set ERROR_FLAG=TRUE
  for /F %%E in (E:\Poll\Bin\SitelistT.txt) do @call :BUILDCMD %%E || set ERROR_FLAG=TRUE
  ...
  for /F %%E in (E:\Poll\Bin\SitelistT2.txt) do @call :BUILDCMD2 %%E || set ERROR_FLAG=TRUE
  @if errorlevel 1 set ERROR_FLAG=TRUE
...
:ERREND
  ...
  @echo.
  @blat %LOG_FILE% -subject "ERROR: CompressStoreMail" -to christian.adams@spencergifts.com
