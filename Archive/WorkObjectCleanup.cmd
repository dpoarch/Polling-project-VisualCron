...
::------------------------------------------------------------------------------
  ...
  @echo.
  @echo Clean RWS work objects by removing client and group assignments.
  @echo.
  @pause
...
:GENSWO
  ...
  C:\RWS\System\Genswo \\sghpnas\pos\Temp\genswo.ec_
...
:CLEANSWO
  ...
  \\sghpnas\pos\Poll\Bin\SWOCleanup.exe
