...
:MAKEBATCH
  ...
  copy ProcessRecoveredTlogsFinal_run_piece1.txt ProcessRecoveredTlogsFinal_run.cmd
  ...
  copy ProcessRecoveredTlogsFinal_run.cmd /A + ProcessRecoveredTlogsFinal_run_piece2.txt /A ProcessRecoveredTlogsFinal_run.cmd /A
...
:BUILDCMD
  :: Build and copy in dynamic piece of subprogram.
  @set TLOG_STORE=%1
  @echo @call :DECOMPRESS %TLOG_STORE% >> E:\Poll\Bin\ProcessRecoveredTlogsFinal_run.cmd
  @echo @if ERRORLEVEL 1 goto ERR >> E:\Poll\Bin\ProcessRecoveredTlogsFinal_run.cmd
  @goto :EOF
...
:DECOMPRESS
  ...
  call E:\Poll\Bin\ProcessRecoveredTlogsFinal_run.cmd
...
:ERREND
  ...
  @echo.
  @blat %LOG_FILE% -subject "ERROR: ProcessRecoveredTlogsFinal" -to christian.adams@spencergifts.com
