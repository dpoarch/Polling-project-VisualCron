...
:COPY538
  :: Copy mail from #538 to #999.
  @call :MESS Begin copy mail from #538 to #999
  ...
  if exist E:\Poll\StoreMailT\Temp\Mail00538 copy E:\Poll\StoreMailT\Temp\Mail00538 E:\Poll\StoreMailT\Temp\Mail00999
  @if errorlevel 1 @call :MESS Error copying store mail from #538 to #999 & set WARNING_FLAG=TRUE

  @call :MESS End copy mail from #538 to #999
